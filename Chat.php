...
class Chat{
    ...
    private $user  = 'root';
    private $password   = "";
    private $database  = "pw_gymregisterv2";      //php_chat sqlQuery		getUserDetails	chatusers	chat_action.php	current header.php
	...
	public function chatUsers($userid){		// Funcion que llama a todos los usuarios que no sean $userid de la tabla "chat_users"
		$sqlQuery = "
	...
	public function getUserChat($from_user_id, $to_user_id) {	// Funcion que devuelve los mensajes que se envian en el chat...
	...
	public function getUnreadMessageCount($senderUserid, $recieverUserid) {	// Funcion que devuelve señal de que aun hay mensajes sin leer..
		$sqlQuery = "
			SELECT * FROM ".$this->chatTable."  
